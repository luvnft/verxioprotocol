        ...
        <div className="mb-8">
          <div className="flex items-center justify-between max-w-2xl mx-auto">
            ...
            <div className="flex-1 relative">
              <div className={`flex items-center justify-center w-12 h-12 rounded-full mx-auto mb-2 ${step === 'program' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
            ...
            {/* Step 2 */}
            <div className="flex-1 relative">
              <div className={`flex items-center justify-center w-12 h-12 rounded-full mx-auto mb-2 ${step === 'pass' ? 'bg-blue-600 text-white' : programId ? 'bg-gray-200 text-gray-600' : 'bg-gray-200 text-gray-400'}`}>
                <span className="text-lg font-semibold">2</span>
              </div>
              <div className="text-center">
                <span className={`text-sm font-medium ${step === 'pass' ? 'text-blue-600' : programId ? 'text-gray-500' : 'text-gray-400'}`}>
                  Loyalty Pass
                </span>
              </div>
              {/* Line to Step 3 */}
            ...
            <div className="flex-1">
              <div className={`flex items-center justify-center w-12 h-12 rounded-full mx-auto mb-2 ${step === 'details' ? 'bg-blue-600 text-white' : userPass ? 'bg-gray-200 text-gray-600' : 'bg-gray-200 text-gray-400'}`}>
                <span className="text-lg font-semibold">3</span>
              </div>
              <div className="text-center">
                <span className={`text-sm font-medium ${step === 'details' ? 'text-blue-600' : userPass ? 'text-gray-500' : 'text-gray-400'}`}>
                  Pass Details
                </span>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {tiers.map((tier, index) => (
                    <div key={index} className="p-4 rounded-lg border border-zinc-700 hover:border-zinc-600 transition-colors">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {Object.entries(actions).map(([name, points]) => (
                    <div key={name} className="p-4 rounded-lg border border-zinc-700 hover:border-zinc-600 transition-colors">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 rounded-full bg-blue-900/30 flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-blue-400" viewBox="0 0 20 20" fill="currentColor">
