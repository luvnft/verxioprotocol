            ...
            <Tabs defaultValue="basics" className="w-full">
              ...
              <TabsContent value="rewards" className="space-y-4">
                          ...
                          {tier.rewards.map((reward, rewardIndex) => (
                            ...
                            >
                              ...
                              <Button
                                ...
                                size="sm"
                                onClick={() => {
                                  const newRewards = tier.rewards.filter(
                                    (_, i) => i !== rewardIndex
                                  );
                                  handleTierConfigChange(
                                    index,
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    {Object.entries(formData.pointsPerAction).map(
                      ([action, points], index) => (
                        <div
                          key={index}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {colorOptions.map((color) => (
                      <Button
                        ...
                        type="button"
                        variant={
                          formData.programColor === color.value
                            ? "default"
                            : "outline"
                        }
                ...
                <Card className="bg-verxio-dark border-verxio-purple/20 p-6">
                  <CardContent className="space-y-4">
                    <div className="text-center">
                      <h3 className="text-xl font-bold text-white mb-2">{formData.organizationName || "Organization Name"}</h3>
                      <p className="text-white/70 text-sm">Created by: {account?.address ? `${account.address.slice(0, 6)}...${account.address.slice(-4)}` : "Wallet Address"}</p>
                    </div>
