      ...
      <Card className={`bg-verxio-dark border ${classes.border} hover:shadow-lg transition-all duration-300 h-full`}>
        <CardContent className="p-6 h-full flex flex-col">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className={`p-2 rounded-full bg-verxio-dark/70 ${classes.icon}`}>
              {icon}
            </div>
          </div>
    ...
    <div className="py-20 px-4 md:px-0">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Enhance customer retention while gaining valuable insights into your customer preferences with our on-chain loyalty solution
          </motion.p>
        </div>
