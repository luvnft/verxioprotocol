  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-white orbitron">Settings</h1>
      </div>
      ...
      <Card className="bg-black/20 backdrop-blur-sm border-slate-800/20">
        <CardContent className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-white/70 text-center max-w-md">
            We're working on something exciting! The settings page will be available soon with new features and
