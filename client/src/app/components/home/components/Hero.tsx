  ...
  return (
    <section className="text-center pt-12 md:pt-20 pb-20 md:pb-32 px-4">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 px-4">
        <a href="https://sandbox.verxio.xyz" className="w-full sm:w-auto bg-[#FFEB3B] text-black px-6 py-3 rounded-lg font-medium hover:bg-[#FFE100] transition-colors">
        Try in Sandbox
        </a>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8 mt-12 md:mt-20 max-w-4xl mx-auto text-left px-4">
        <div className="bg-white/5 p-4 md:p-6 rounded-xl hover:bg-white/10 transition-colors">
          ...
          <p className="text-gray-400 text-sm md:text-base">Earn XPs through meaningful interactions and community participation</p>
        </div>
        <div className="bg-white/5 p-4 md:p-6 rounded-xl hover:bg-white/10 transition-colors">
